...
lyr_googleearth_0.setVisible(true);lyr_mukim_mlk_1.setVisible(true);lyr_district_mlk_2.setVisible(true);lyr_PulaudanPantai_3.setVisible(true);
var layersList = [lyr_googleearth_0,lyr_mukim_mlk_1,lyr_district_mlk_2,lyr_PulaudanPantai_3];
...
lyr_PulaudanPantai_3.on('precompose', function(evt) {
